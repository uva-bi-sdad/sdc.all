...
# save
readr::write_csv(temp2, xzfile(paste0(savepath,"va059_ct_mi_",min(temp2$year),max(temp2$year),"_exit.csv.xz"), compression = 9))
...
# save
readr::write_csv(temp2, xzfile(paste0(savepath,"ncr_ct_mi_",min(temp2$year),max(temp2$year),"_exit.csv.xz"), compression = 9))
...
# save
readr::write_csv(temp2, xzfile(paste0(savepath,"va_ct_mi_",min(temp2$year),max(temp2$year),"_exit.csv.xz"), compression = 9))
