...
readr::write_csv(job_creation, xzfile(paste0(savepath,"va059_bg_mi_",min(job_creation$year),max(job_creation$year),"_jobs_creation_by_industry.csv.xz"), compression = 9))
