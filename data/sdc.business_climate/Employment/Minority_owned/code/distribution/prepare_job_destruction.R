...
# save
readr::write_csv(temp1, xzfile(paste0(savepath,"va059_tr_mi_",min(temp1$year),max(temp1$year),"_jobs_destruction_by_minority.csv.xz"), compression = 9))
...
# save
readr::write_csv(temp2, xzfile(paste0(savepath,"va059_ct_mi_",min(temp2$year),max(temp2$year),"_jobs_destruction_by_minority.csv.xz"), compression = 9))
