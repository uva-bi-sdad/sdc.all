...
#data -  Dept of Labor
childcare_dol <- read_excel("~/git/cost-living/data/Child care cost/data/Original/DOL_Childcare.xlsx")
#data county
...
childcare_cost <-  q1_income_puma %>% mutate(childcare_cost_month= 
