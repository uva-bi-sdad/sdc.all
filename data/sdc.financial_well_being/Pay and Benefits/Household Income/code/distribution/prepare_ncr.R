...
dt_ncr_final <- dt_ncr[, c('geoid', 'year', 'measure', 'value', 'moe')]

readr::write_csv(dt_ncr_final,
                 xzfile("Pay and Benefits/Household Income/data/distribution/ncr_cttrbg_2015_2023_median_household_income.csv.xz", compression=9),
                 append = FALSE)
