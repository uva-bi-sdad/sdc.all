...
write.csv(va_hdcttr_partic_rt_all, file = xzfile(paste0("Employment/data/distribution/va_hdcttr_", min(yrs), "_", max(yrs), "_labor_participate_rate.csv.xz")), row.names = FALSE)
...
## convert
rcsv <- read.csv(xzfile(paste0("Employment/data/distribution/va_hdcttr_", min(yrs), "_", max(yrs), "_labor_participate_rate.csv.xz"), open = "r"))
stnd <- standardize_all(rcsv)

# save standardized file
write.csv(stnd, file = xzfile(paste0("Employment/data/distribution/va_hdcttr_", min(yrs), "_", max(yrs), "_labor_participate_rate_std.csv.xz")), row.names = FALSE)
