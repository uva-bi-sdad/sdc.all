  ...
  for(geography in geographies)
  {
    data_one_yr <- get_acs(geography = geography, variables = vars, state = c("VA", "MD", "DC"),
      ...
      transmute(
        ...
        wht_men_pov_pct = ifelse(wht_men_cnt == 0, NA, 100*wht_men_pov_cnt/wht_men_cnt),
        ...
        wht_women_pov_pct =  ifelse(wht_women_cnt == 0, NA, 100*wht_women_pov_cnt/wht_women_cnt),
        ...
        blk_men_pov_pct = ifelse(blk_men_cnt == 0, NA, 100*blk_men_pov_cnt/blk_men_cnt),
        ...
        blk_women_pov_pct = ifelse(blk_women_cnt == 0, NA, 100*blk_women_pov_cnt/blk_women_cnt),
        ...
        asian_men_pov_pct = ifelse(asian_men_cnt == 0, NA, 100*asian_men_pov_cnt/asian_men_cnt),
        ...
        asian_women_pov_pct = ifelse(asian_women_cnt == 0, NA, 100*asian_women_pov_cnt/asian_women_cnt),
        ...
        othr_men_pov_pct = ifelse(othr_men_cnt == 0, NA, 100*othr_men_pov_cnt /othr_men_cnt),
        ...
        othr_women_pov_pct = ifelse(othr_women_cnt == 0, NA, 100*othr_women_pov_cnt/othr_women_cnt),
        ...
        wht_nonhis_men_pov_pct = ifelse(wht_nonhis_men_cnt == 0, NA, 100*wht_nonhis_men_pov_cnt/wht_nonhis_men_cnt),
        ...
        wht_nonhis_women_pov_pct = ifelse(wht_nonhis_women_cnt == 0, NA, 100*wht_nonhis_women_pov_cnt/wht_nonhis_women_cnt),
        ...
        his_men_pov_pct = ifelse(his_men_cnt == 0, NA, 100*his_men_pov_cnt/his_men_cnt),
        ...
        his_women_pov_pct = ifelse(his_women_cnt == 0, NA, 100*his_women_pov_cnt/his_women_cnt)
      ) %>%
      arrange(geoid)
