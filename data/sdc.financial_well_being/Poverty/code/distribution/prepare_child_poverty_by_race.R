  ...
  for(geography in geographies)
  {
    data_one_yr <- get_acs(geography = geography, variables = vars, state = c("VA", "MD", "DC"),
      ...
      transmute(
        ...
        wht_boys_pov_pct = ifelse(wht_boys_cnt == 0, NA, 100*wht_boys_pov_cnt/wht_boys_cnt),
        ...
        wht_girls_pov_pct =  ifelse(wht_girls_cnt == 0, NA, 100*wht_girls_pov_cnt/wht_girls_cnt),
        ...
        blk_boys_pov_pct = ifelse(blk_boys_cnt == 0, NA, 100*blk_boys_pov_cnt/blk_boys_cnt),
        ...
        blk_girls_pov_pct = ifelse(blk_girls_cnt == 0, NA, 100*blk_girls_pov_cnt/blk_girls_cnt),
        ...
        asian_boys_pov_pct = ifelse(asian_boys_cnt == 0, NA, 100*asian_boys_pov_cnt/asian_boys_cnt),
        ...
        asian_girls_pov_pct = ifelse(asian_girls_cnt == 0, NA, 100*asian_girls_pov_cnt/asian_girls_cnt),
        ...
        othr_boys_pov_pct = ifelse(othr_boys_cnt == 0, NA, 100*othr_boys_pov_cnt /othr_boys_cnt),
        ...
        othr_girls_pov_pct = ifelse(othr_girls_cnt == 0, NA, 100*othr_girls_pov_cnt/othr_girls_cnt),
        ...
        wht_nonhis_boys_pov_pct = ifelse(wht_nonhis_boys_cnt == 0, NA, 100*wht_nonhis_boys_pov_cnt/wht_nonhis_boys_cnt),
        ...
        wht_nonhis_girls_pov_pct = ifelse(wht_nonhis_girls_cnt == 0, NA, 100*wht_nonhis_girls_pov_cnt/wht_nonhis_girls_cnt),
        ...
        his_boys_pov_pct = ifelse(his_boys_cnt == 0, NA, 100*his_boys_pov_cnt/his_boys_cnt),
        ...
        his_girls_pov_pct = ifelse(his_girls_cnt == 0, NA, 100*his_girls_pov_cnt/his_girls_cnt)
      ) %>%
      arrange(geoid)
