...
us_geo_census_cb_2010_counties <- sf::st_read("NCR/Census Geographies/County/2010/data/original/us_geo_census_cb_2010_counties.geojson")
...
ncr_geo_census_cb_2010_counties <- us_geo_census_cb_2010_counties[us_geo_census_cb_2010_counties$geoid %in% ncr_geoids,]
...
sf::st_write(ncr_geo_census_cb_2010_counties, "NCR/Census Geographies/County/2010/data/distribution/ncr_geo_census_cb_2010_counties.geojson",
             delete_dsn=TRUE)
