...
us_geo_census_cb_2010_counties <- sf::st_read("data/ncr_geo_census_cb_2010_counties/original/us_geo_census_cb_2010_counties.geojson")
...
sf::st_write(ncr_geo_census_cb_2010_counties, "data/ncr_geo_census_cb_2010_counties/distribution/ncr_geo_census_cb_2010_counties.geojson")
