...
us_geo_census_cb_2010_census_tracts <- sf::st_read("data/dc_geo_census_cb_2010_census_tracts/original/us_geo_census_cb_2010_census_tracts.geojson")
...
sf::st_write(dc_geo_census_cb_2010_census_tracts, "data/dc_geo_census_cb_2010_census_tracts/distribution/dc_geo_census_cb_2010_census_tracts.geojson")
