...
dc_geo_census_cb_2010_census_block_groups <- sf::st_read("data/dc_geo_census_cb_2010_census_block_groups/original/dc_geo_census_cb_2010_census_block_groups.geojson")
...
sf::st_write(final_dataset_simplified, "data/dc_geo_census_cb_2010_census_block_groups/distribution/dc_geo_census_cb_2010_census_block_groups.geojson")
