...
ncr_brfss_2018 <- readRDS("~/projects_data/ncr_brfss_2018.rds")
...
st_prev_logit <- qlogis(unname(svymean(~physhlth_binary, ncr_brfss_2018_design)[1]))
...
saveRDS(phys_tract_res, "~/git/vdh_brfss_res/phys_2018_pred_ncr.rds")
