...
ncr_brfss_2016 <- readRDS("~/projects_data/ncr_brfss_2016.rds")
...
st_prev_logit <- qlogis(unname(svymean(~physhlth_binary, ncr_brfss_2016_design)[1]))
...
saveRDS(phys_tract_res, "~/git/vdh_brfss_res/phys_2016_pred_ncr.rds")
