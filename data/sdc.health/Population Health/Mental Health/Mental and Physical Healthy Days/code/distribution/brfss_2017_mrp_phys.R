...
st_prev_logit <- qlogis(unname(svymean(~physhlth_binary, brfss_2017_design)[1]))
...
saveRDS(phys_tract_res, "/project/biocomplexity/sdad/projects_data/vdh/dc_health_behavior_diet/brfss/phys_2017_pred.rds")
