...
ncr_brfss_2017 <- readRDS("~/projects_data/ncr_brfss_2017.rds")
...
st_prev_logit <- qlogis(unname(svymean(~physhlth_binary, ncr_brfss_2017_design)[1]))
...
saveRDS(phys_tract_res, "~/git/vdh_brfss_res/phys_2017_pred_ncr.rds")
