...
st_prev_logit <- qlogis(unname(svymean(~physhlth_binary, brfss_2015_design)[1]))
...
saveRDS(phys_tract_res, "/project/biocomplexity/sdad/projects_data/vdh/dc_health_behavior_diet/brfss/phys_2015_pred.rds")
