...
st_prev_logit <- qlogis(unname(svymean(~menthlth_binary, brfss_2018_design)[1]))
...
saveRDS(ment_tract_res, "/project/biocomplexity/sdad/projects_data/vdh/dc_health_behavior_diet/brfss/ment_2018_pred.rds")
