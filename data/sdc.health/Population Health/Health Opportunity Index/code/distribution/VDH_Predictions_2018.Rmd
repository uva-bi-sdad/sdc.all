...
cor(inc_2018_predicted, data_matrix$Incarceration)
```
...
```{r}
indicators_2018 = hoi_recreated_normalized_2018 %>% mutate(Incarceration = inc_2018_predicted)
```
...
```{r}
incarceration_data_2018 = indicators_2018 %>% select(geoid) %>% mutate(year = 2018) %>% mutate(measure = "incarceration_rate_per_100000") %>% mutate(value = inc_2018_predicted) %>% mutate(moe = NA)

incarceration_data_2018
