...
orig_df <- read_excel("data/original/mat_depr.xlsx")
...
out_df <- df_tracts_nodups %>% 
  rename("geoid"= "Ctfips",
        "material_deprivation_quintile" = "quintiles",
        "material_deprivation_level" = "Indicator Selector")
out_df <- out_df[,c("geoid", "material_deprivation_quintile", "material_deprivation_level")]
...
# save the dataset 
write_csv(out_df, "data/distribution/va_tr_vdh_2017_material_deprivation_index.csv")
