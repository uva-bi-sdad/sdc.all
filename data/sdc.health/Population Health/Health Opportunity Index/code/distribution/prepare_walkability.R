...
orig_df <- read_excel("data/original/walk.xlsx")
...
out_df <- df_tracts_nodups %>% 
  rename("geoid"= "Ctfips",
        "walkability_quintile" = "quintiles",
        "walkability_level" = "Indicator Selector")
out_df <- out_df[,c("geoid", "walkability_quintile", "walkability_level")]
...
# save the dataset 
write_csv(out_df, "data/distribution/va_tr_vdh_2017_walkability_index.csv")
