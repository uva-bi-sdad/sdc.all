...
orig_df <- read_excel("data/original/pop_density.xlsx")
...
out_df <- df_tracts_nodups %>% 
  rename("geoid"= "Ctfips",
        "pop_density_quintile" = "quintiles",
        "pop_density_level" = "Indicator Selector")
out_df <- out_df[,c("geoid", "pop_density_quintile", "pop_density_level")]
...
# save the dataset 
write_csv(out_df, "data/distribution/va_tr_vdh_2017_pop_density_index.csv")
