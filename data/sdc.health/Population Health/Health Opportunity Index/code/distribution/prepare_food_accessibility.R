...
orig_df <- read_excel("data/original/food_access.xlsx")
...
out_df <- df_tracts_nodups %>% 
  rename("geoid"= "Ctfips",
        "food_accessibility_quintile" = "quintiles",
        "food_accessibility_level" = "Indicator Selector")
out_df <- out_df[,c("geoid", "food_accessibility_quintile", "food_accessibility_level")]
...
# save the dataset 
write_csv(out_df, "data/distribution/va_tr_vdh_2017_food_accessibility_index.csv")
