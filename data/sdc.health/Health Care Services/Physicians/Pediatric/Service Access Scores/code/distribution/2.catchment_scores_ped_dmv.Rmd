---
title: "catchment_scores -  pediatrics"
author: "--"
date: "2/4/2022"
...
map <- leaflet(blockgroup_shapes, options = leafletOptions(attributionControl = FALSE)) %>%
  ...
  addCircles(
    ...
    label = ~ paste0("ID: ", ID), group = "Pediatrics", options = pathOptions(pane = "points")
  )
```
...
names(dmv_bg_2021_acccess_scores_tract_wide)[2] <- 'ped_pop_cnt'
...
#write the name of population again, the name was change to avoid conflict when calculating weighted mean
names(dmv_bg_2021_acccess_scores_county_wide)[2] <- 'ped_pop_cnt'
...
```{r}
dmv_bg_2021_acccess_scores_pediatrics <- rbind(dmv_bg_2021_acccess_scores_bg, 
...
# write.csv(dmv_bg_2021_acccess_scores_pediatrics, "dmv_cttrbg_webmd_2021_access_scores_pediatrics.csv", row.names = FALSE )
readr::write_csv(dmv_bg_2021_acccess_scores_pediatrics, xzfile("ncr_cttrbg_webmd_2021_access_scores_pediatrics.csv.xz", compression = 9))
...
# sf::st_write(
#   dmv_bg_2021_acccess_scores_pediatrics, con,
#   c("dc_health_behavior_diet", "dmv_cttrbg_webmd_2021_acccess_scores_pediatrics"),
