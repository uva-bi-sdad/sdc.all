...
#open geometry into two columns 
provider <- provider %>%
...
pop_va_dc_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
...
pop_md_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_pa_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_ky_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_nc_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_tn_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_wv_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_de_pediatric <- get_acs(geography = "block group", 
                      year = 2020,
                      variables = c(population = "B01001_001",
                                    Male="B01001_002",
                                    MaleUnder5years="B01001_003",
...
pop_va_buffer_pediatric <- rbind(pop_va_dc_pediatric, pop_de_pediatric, pop_ky_pediatric, pop_md_pediatric, pop_nc_pediatric, pop_pa_pediatric, pop_tn_pediatric, pop_wv_pediatric)


va <- pop_va_buffer_pediatric %>% mutate( pediatric_pop= MaleUnder5yearsE+Male5to9yearsE+Male10to14yearsE+Male15to17yearsE+
...
geopts <- provider %>%
  st_as_sf(coords = c("lon", "lat"), crs = 4326) #4326. initial: 4269
# indeces of bgs which contain a geopoint
# st_crs(geopts)
# st_crs(blocks)
#st_transform(blocks, 4326)
...
population <- data_combined %>% select(GEOID, population, pediatric_pop, prov_cnt=prov_cnt,  near_10_mean=near_10_mean, near_10_median=near_10_median, X, Y)
