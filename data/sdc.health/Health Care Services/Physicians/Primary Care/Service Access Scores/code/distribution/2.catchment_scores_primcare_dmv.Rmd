...
names(dmv_bg_2021_acccess_scores_tract_wide)[2] <- 'primcare_pop_cnt'
...
#write the name of population again, the name was change to avoid conflict when calculating weighted mean
names(dmv_bg_2021_acccess_scores_county_wide)[2] <- 'primcare_pop_cnt'
...
```{r}
dmv_bg_2021_acccess_scores_primcare <- rbind(dmv_bg_2021_acccess_scores_bg, 
...
# write.csv(dmv_bg_2021_acccess_scores_primcare, "dmv_cttrbg_webmd_2021_acccess_scores_primcare", row.names = FALSE )
readr::write_csv(dmv_bg_2021_acccess_scores_primcare, xzfile("ncr_cttrbg_webmd_2021_access_scores_primcare.csv.xz", compression = 9))

#dmv_bg_2021_acccess_scores_primcare <- read.csv("dmv_cttrbg_webmd_2021_acccess_scores_primcare")
...
sf::st_write(
  dmv_bg_2021_acccess_scores_primcare, con,
  c("dc_health_behavior_diet", "dmv_cttrbg_webmd_2021_access_scores_primcare"),
