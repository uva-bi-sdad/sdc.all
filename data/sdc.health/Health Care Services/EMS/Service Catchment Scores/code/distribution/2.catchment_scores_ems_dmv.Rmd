...
plot_2sfca <- map %>%
  addControl("Emergency Medical Services Per 1,000 People (2-Step Floating Catchment Area)", "topright") %>%
...
plot_e2sfca <- map %>%
  addControl("Emergency Medical Services Per 1,000 People (enhanced 2-Step Floating Catchment Area)", "topright") %>%
...
plot_3sfca <- map %>%
  addControl("Emergency Medical Services Per 1,000 People \n (3-Step Floating Catchment Area)", "topright") %>%
...
dmv_bg_2021_acccess_scores_wide <- population   %>% dplyr::select( geoid="GEOID", 
                                                            ems_pop_cnt ="population",
                                                            ems_cnt = "hosp_cnt",
                                                            ems_near_10_mean = "near_10_mean",
                                                            ems_near_10_median = "near_10_median",
                                                            ems_2sfca = "providers_2sfca" ,
                                                            ems_e2sfca = "providers_e2sfca", 
                                                            ems_3sfca = "providers_3sfca" )
```
...
#define measure type
dmv_bg_2021_acccess_scores_bg$measure_type <- as.factor(ifelse(dmv_bg_2021_acccess_scores_bg$measure=="ems_2sfca" |
                                                            dmv_bg_2021_acccess_scores_bg$measure=="ems_e2sfca" |
                                                              dmv_bg_2021_acccess_scores_bg$measure=="ems_3sfca", 'index','count') )
```
...
dmv_bg_2021_acccess_scores_tract_wide <- dmv_bg_2021_acccess_scores_wide_aggreg %>% group_by(tract_geoid) %>% summarise(
  ems_pop = sum(ems_pop_cnt, na.rm = TRUE), 
  ems_cnt = sum(ems_cnt, na.rm = TRUE), 
  ems_near_10_mean = weighted.mean(ems_near_10_mean, ems_pop_cnt, na.rm = TRUE), 
  ems_near_10_median = weighted.mean(ems_near_10_median, ems_pop_cnt, na.rm = TRUE), 
...
#define measure type
dmv_bg_2021_acccess_scores_tract$measure_type <- as.factor(ifelse(dmv_bg_2021_acccess_scores_tract$measure=="ems_2sfca" |
                                                            dmv_bg_2021_acccess_scores_tract$measure=="ems_e2sfca" |
                                                              dmv_bg_2021_acccess_scores_tract$measure=="ems_3sfca", 'index','count') )
```
...
#define measure type
dmv_bg_2021_acccess_scores_county$measure_type <- as.factor(ifelse(dmv_bg_2021_acccess_scores_county$measure=="ems_2sfca" |
                                                            dmv_bg_2021_acccess_scores_county$measure=="ems_e2sfca" |
                                                              dmv_bg_2021_acccess_scores_county$measure=="ems_3sfca", 'index','count') )
```
...
```{r}
dmv_bg_2021_acccess_scores_ems <- rbind(dmv_bg_2021_acccess_scores_bg, 
                                    dmv_bg_2021_acccess_scores_tract,
                                    dmv_bg_2021_acccess_scores_county)
```
#change one name
```{r}
dmv_bg_2021_acccess_scores_ems <- read.csv("dmv_bg_2021_acccess_scores_ems")

dmv_bg_2021_acccess_scores_ems$measure <- ifelse(dmv_bg_2021_acccess_scores_ems$measure=='ems_pop', 'ems_pop_cnt' , dmv_bg_2021_acccess_scores_ems$measure)
```
...
write.csv(dmv_bg_2021_acccess_scores_ems, "dmv_cttrbg_hifld_2021_access_scores_ems.csv", row.names = FALSE )

#dmv_cttrbg_webmd_2021_access_scores_dentists.csv
...
# sf::st_write(
#   dmv_bg_2021_acccess_scores_ems, con,
#   c("dc_health_behavior_diet", "dmv_cttrbg_hifld_2021_acccess_scores_ems"),
