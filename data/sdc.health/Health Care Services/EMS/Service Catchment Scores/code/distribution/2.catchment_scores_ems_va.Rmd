...
plot_2sfca <- map %>%
  addControl("Hospitals Per 1000 People (2-Step Floating Catchment Area)", "topright") %>%
...
plot_e2sfca <- map %>%
  addControl("Hospitals Per 1000 People (enhanced 2-Step Floating Catchment Area)", "topright") %>%
...
plot_3sfca <- map %>%
  addControl("Hospitals Per 1000 People (3-Step Floating Catchment Area)", "topright") %>%
...
#define measure type
dmv_bg_2021_acccess_scores_hd$measure_type <- as.factor(ifelse(dmv_bg_2021_acccess_scores_hd$measure=="ems_2sfca" |
                                                            dmv_bg_2021_acccess_scores_hd$measure=="ems_e2sfca" |
                                                              dmv_bg_2021_acccess_scores_hd$measure=="ems_3sfca", 'index','count') )
...
```{r}
va_bg_2021_access_scores_ems <- rbind(dmv_bg_2021_acccess_scores_bg, 
...
#change one name
va_bg_2021_access_scores_ems$measure <- ifelse(va_bg_2021_access_scores_ems$measure=='ems_pop', 'ems_pop_cnt' , va_bg_2021_access_scores_ems$measure)
```
...
write.csv(va_bg_2021_access_scores_ems, "va_hdcttrbg_hifld_2021_access_scores_ems.csv", row.names = FALSE )
