...
#working directory
```{r}
setwd("~/VDH/Floating_Catchment_Areas/dmv/9. substance_dmv_model/")
```
# read data
```{r}
...
plot_2sfca <- map %>%
  addControl("Substance Use Facilities Per 1,000 People (2-Step Floating Catchment Area)", "topright") %>%
...
plot_e2sfca <- map %>%
  addControl("Substance Use Facilities Per 1,000 People (enhanced 2-Step Floating Catchment Area)", "topright") %>%
...
plot_3sfca <- map %>%
  addControl("Substance Use Facilities Per 1,000 People (3-Step Floating Catchment Area)", "topright") %>%
...
names(dmv_bg_2021_acccess_scores_tract_wide)[2] <- 'subs_pop_cnt'
...
#write the name of population again, the name was change to avoid conflict when calculating weighted mean
names(dmv_bg_2021_acccess_scores_county_wide)[2] <- 'subs_pop_cnt'
...
```{r}
dmv_bg_2021_acccess_scores_substance <- rbind(dmv_bg_2021_acccess_scores_bg, 
...
write.csv(dmv_bg_2021_acccess_scores_substance, "dmv_cttrbg_samhsa_2021_access_scores_substance.csv", row.names = FALSE )

#dmv_bg_2021_acccess_scores_substance <-  read.csv("dmv_cttrbg_hifld_2021_acccess_scores_substance")
...
# sf::st_write(
#   dmv_bg_2021_acccess_scores_substance, con,
#   c("dc_health_behavior_diet", "dmv_cttrbg_samhsa_2021_acccess_scores_substance"),
