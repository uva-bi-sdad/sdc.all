...
provider <- sf::st_read(
  ...
  query= "
SELECT  *
FROM dc_health_behavior_diet.ncr_pl_samhsa_2021_substance_use_facilities "
)
...
#write
write.csv(provider, "substance_care.csv" )

```
# load data provider
```{r}
provider <- read.csv("substance_care.csv", row.names = 1)
