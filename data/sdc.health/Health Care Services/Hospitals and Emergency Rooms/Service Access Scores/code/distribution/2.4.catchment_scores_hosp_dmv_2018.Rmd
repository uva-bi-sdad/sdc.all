...
# write.csv(dmv_bg_2021_acccess_scores_hospitals, "ncr_bgtrct_2018_acccess_scores_hospitals.csv", row.names = FALSE )
readr::write_csv(dmv_bg_2021_acccess_scores_hospitals, xzfile("ncr_bgtrct_2018_access_scores_hospitals.csv", compression = 9))
