...
#working directory
```{r}
setwd("~/VDH/Floating_Catchment_Areas/dmv/5.1 hospitals_dmv_model_2015-2022/5.1 hospitals_dmv_model_2015")
```
# read data
```{r}
year_spec <- 2015
...
readr::write_csv(dmv_bg_2021_acccess_scores_hospitals, xzfile("ncr_bgtrct_2015_acccess_scores_hospitals.csv.xz", compression = 9))
