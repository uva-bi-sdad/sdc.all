...
# Working directory
```{r}
setwd("~/VDH/Floating_Catchment_Areas/va/5. hospitals_va_model/general_acute_care")
```
# Read data
```{r}
population <- read.csv("~/VDH/Floating_Catchment_Areas/va/5. hospitals_va_model/general_acute_care/population.csv")
provider <- read.csv("~/VDH/Floating_Catchment_Areas/va/5. hospitals_va_model/general_acute_care/provider_20.csv")
rownames(provider) <- provider$ID
traveltimes <- read.csv("~/VDH/Floating_Catchment_Areas/va/5. hospitals_va_model/general_acute_care/traveltimes_trimmed_20.csv", row.names = 1)
...
map <- leaflet(blockgroup_shapes, options = leafletOptions(attributionControl = FALSE)) %>%
  ...
  addCircles(
    ...
    label = ~ paste0("ID: ", ID, "  N. hospitals: ", doctors),  options = pathOptions(pane = "points")
  )
```
...
plot_2sfca <- map %>%
  addControl("Hospitals Per 10,000 People (2-Step Floating Catchment Area)", "topright") %>%
...
plot_e2sfca <- map %>%
  addControl("Hospitals Per 10,000 People (enhanced 2-Step Floating Catchment Area)", "topright") %>%
...
plot_3sfca <- map %>%
  addControl("Hospitals Per 10,000 People (3-Step Floating Catchment Area)", "topright") %>%
...
#define measure type
dmv_bg_2021_acccess_scores_hd$measure_type <- as.factor(ifelse(dmv_bg_2021_acccess_scores_hd$measure=="hosp_2sfca" |
                                                            dmv_bg_2021_acccess_scores_hd$measure=="hosp_e2sfca" |
                                                              dmv_bg_2021_acccess_scores_hd$measure=="hosp_3sfca", 'index','count') )
...
```{r}
va_bg_2021_access_scores_hosp <- rbind(dmv_bg_2021_acccess_scores_bg, 
                                    dmv_bg_2021_acccess_scores_tract,
                                    dmv_bg_2021_acccess_scores_county, 
                                    dmv_bg_2021_acccess_scores_hd)

#change one name
va_bg_2021_access_scores_hosp$measure <- ifelse(va_bg_2021_access_scores_hosp$measure=='hosp_pop', 'hosp_pop_cnt' , va_bg_2021_access_scores_hosp$measure)

va_bg_2021_access_scores_hosp$measure <- ifelse(va_bg_2021_access_scores_hosp$measure=='hosp_cnt', 'hosp_beds_cnt' , va_bg_2021_access_scores_hosp$measure)
```
...
write.csv(va_bg_2021_access_scores_hosp, "/home/cpm9w/VDH/Floating_Catchment_Areas/va/5. hospitals_va_model/general_acute_care/va_hdcttrbg_hifld_2021_access_scores_hospitals.csv", row.names = FALSE )
