...
#working directory
```{r}
setwd("~/VDH/Floating_Catchment_Areas/dmv/5.1 hospitals_dmv_model_2015-2022/5.1 hospitals_dmv_model_2017")
getwd()
```
# read data
```{r}
...
# write.csv(dmv_bg_2021_acccess_scores_hospitals, "ncr_bgtrct_2017_acccess_scores_hospitals.csv", row.names = FALSE )
readr::write_csv(dmv_bg_2021_acccess_scores_hospitals, xzfile("ncr_bgtrct_2017_access_scores_hospitals.csv.xz", compression = 9))
