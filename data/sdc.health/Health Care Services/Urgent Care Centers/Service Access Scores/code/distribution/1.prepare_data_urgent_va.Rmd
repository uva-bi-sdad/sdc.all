...
provider <- read_csv("/home/cpm9w/test_symlink/urgent_care/Urgent_Care_Facilities.csv" )
  
  
provider <- provider %>% filter(STATE == 'VA' | FIPS %in% buffer_counties_state$identifier) %>% select(ID, NAME, ADDRESS, CITY, STATE, COUNTY, FIPS, lat=Y, lon=X)

#Save list of hospitals:93 in VA
#write_csv(provider, "va_hifld_2021_urgent_care.csv")
