...
readr::write_csv(acs_data_va, xzfile(paste0(savepath,"va_trctbg_acs_2009_2021_veteran_demographics.csv.xz"), compression = 9))
readr::write_csv(acs_data_ncr, xzfile(paste0(savepath,"ncr_trctbg_acs_2009_2021_veteran_demographics.csv.xz"), compression = 9))
