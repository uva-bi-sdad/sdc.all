...
uploadpath <- "Veteran/data/working/model/"
...
readr::write_csv(combined, xzfile(paste0(savepath, "va_hsrsdpdzccttrbg_sdad_",min(yearlist),'_',max(yearlist),"_veteran_demographics.csv.xz"), compression = 9))